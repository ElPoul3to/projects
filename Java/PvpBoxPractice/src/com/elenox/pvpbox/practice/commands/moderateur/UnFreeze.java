            ...
            if(label.equalsIgnoreCase("unfreeze")){
                if(args.length == 0){
                    ...
                    if(requester == null){
                        ...
                        ListManager.playerFrozen.remove(requester);
                        player.sendMessage(PvpBoxPractice.getModerationPrefix()+"§7Vous avez §a§lUnFreeze §3"+requester.getDisplayName());
                        requester.sendMessage(PvpBoxPractice.getPrefix()+"§7Vous êtes §a§lUnFreeze.");
                        return true;
                    }
                }
            }
