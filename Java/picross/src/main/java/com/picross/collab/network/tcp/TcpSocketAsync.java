...
public class TcpSocketAsync extends TcpSocket{
	...
	private int expectedMessageSize = -1;
	...
	public boolean isInitialMessageSent() {
		return initialMessageSent;
	}

	public void setInitialMessageSent(boolean initialMessageSent) {
	...
	public boolean isConnected() {
		return getRwChan().isOpen() && getRwChan().socket().isConnected();
	}
